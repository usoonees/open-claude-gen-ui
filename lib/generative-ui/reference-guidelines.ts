...
- The widget container is \`display: block; width: 100%\`. Your HTML fills it naturally — no outer wrapper div needed. Start with the actual content. Do not add root-level \`padding\` or \`font-family: var(--font-sans)\`; the host already owns message spacing and font inheritance.
